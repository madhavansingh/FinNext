...
const RISK_AGENT_ID = "692728c474293a73c735c927";
const RISK_API_KEY = process.env.RISK_AGENT_API_KEY || "YOUR_PORTFOLIO_AGENT_API_KEY_HERE"; 
  ...
  try {
    ...
    const res = await fetch(NEW_AGENT_URL, {
      ...
      body: JSON.stringify({
        ...
        session_id: `${RISK_AGENT_ID}-${SESSION_ID}`, 
